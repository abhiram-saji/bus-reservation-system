...
$sql = "
    ...
    FROM feedback,book,register,bus,travel where feedback.book_id = book.book_id and register.login_id=book.userId and bus.bus_id=book.b_id and travel.login_id=bus.login_id and travel.login_id=$log ";
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="min-height: 50vh;">
                ...
                <div class="carousel-caption">
                    <h1 class="display-2 text-capitalize text-white mb-4">Feedback DETAILS</h1>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="info">Customer Email</th>
