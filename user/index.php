                ...
                <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="img/road.jpg" class="img-fluid" alt="Image">
                            <div class="carousel-caption">
                                <div class="p-3" >
                                    <!-- <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Explore The World</h4>
                                    <h1 class="display-2 text-capitalize text-white mb-4">Let's The World Together!</h1> -->
                                    <p class="mb-5 fs-5">Welcome to YATHRA! Your go-to destination for hassle-free bus reservations. Easily search for routes, and book your tickets online. Enjoy a seamless travel experience with real-time updates and a range of options to suit your needs. Start planning your next journey with us today!
                                    </p>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="select_route.php">Book Seat</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="carousel-item">
                            <img src="img/bus.jpg" class="img-fluid" alt="Image">
                            <div class="carousel-caption">
                        ...
                        <!-- <div class="carousel-item">
                            <img src="img/kochi.jpg" class="img-fluid" alt="Image">
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    <p class="mb-5 fs-5">Welcome to YATHRA! Your go-to destination for hassle-free bus reservations. Easily search for routes, and book your tickets online. Enjoy a seamless travel experience with real-time updates and a range of options to suit your needs. Start planning your next journey with us today!
                                    </p>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(img/about-img-1.png);">
                        ...
                        <h1 class="mb-4">Welcome to <span class="text-primary">Yathra</span></h1>
