                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    ...
                                    <p class="mb-5 fs-5">Welcome to Yathra! Your go-to destination for hassle-free bus reservations. Easily search for routes, and book your tickets online. Enjoy a seamless travel experience with real-time updates and a range of options to suit your needs. Start planning your journey with us today!
                                    </p>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="login.php">Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>
