...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2024 at 11:16 AM
...
INSERT INTO `book` (`book_id`, `bookedseats`, `userId`, `b_id`) VALUES
(39, 0x315f312c315f322c315f352c315f36, 2, 1),
(40, 0x325f36, 2, 1),
(41, 0x325f35, 2, 1),
(42, 0x325f322c325f31, 2, 1),
(43, 0x325f322c325f31, 2, 1),
(44, 0x325f322c325f31, 2, 1),
(45, 0x325f322c325f31, 2, 1),
(46, 0x325f322c325f31, 2, 1),
(47, 0x325f322c325f31, 2, 1),
(48, 0x325f322c325f31, 2, 1),
(49, 0x325f322c325f31, 2, 1),
(50, 0x335f352c345f352c355f352c365f352c365f362c355f362c345f362c335f36, 2, 1),
(51, 0x335f312c335f32, 2, 1),
(55, 0x315f352c315f36, 2, 2);
...
(1, 'yathra', '07:00', '20:00', 'kl 39389', 'bus.jpg', '2024-10-22', 'BUS1.avif', '1', 4),
(2, 'yathra', '12:41', '00:39', 'kl 39389', 'BUS1.avif', '2024-10-22', 'about-img.jpg', '1', 4);
...
INSERT INTO `feedback` (`feed_id`, `cust_id`, `book_id`, `comment`, `rate`) VALUES
(19, 2, 39, 'erty', '⭐⭐⭐⭐⭐');
...
--
ALTER TABLE `book`
  MODIFY `book_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT for table `bus`
--
ALTER TABLE `bus`
  MODIFY `bus_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
